	...
	for P in P_list:
		...
		#---Simulate data
			...
			#---L1 SVM 
				...
				beta_L1_SVM, support_L1_SVM, time_L1_SVM, model_L1_SVM_no_WS, _, obj_val_L1_SVM = L1_SVM_CG(X_train, y_train, range(P), alpha, 0, time_limit, model_L1_SVM_no_WS, [], False, f) #_ = range(P) 
...
#---Compare times
	...
	#L1_SVM_CG_plots_path(type_Sigma, N, P_list, k0, rho, tau_SNR, times_L1_SVM, times_method_1, times_method_2)
	#plt.savefig(pathname+'/compare_times_boxplot.png')
	#plt.close()


#---PLOT 1 Compare everybody
	legend_plot_1 = {0:'No CG', 1:'CG with correlation, eps=5e-1', 2:'CG with correlation, eps=1e-1', 3:'CG with correlation, eps=1e-2'}
	times_list  = [times_L1_SVM, times_method_1, times_method_2, times_method_3]

	L1_SVM_CG_plots_errorbar(type_Sigma, N, P_list, k0, rho, tau_SNR, times_list, legend_plot_1, 'time')
	plt.savefig(pathname+'/compare_times_errorbar.pdf')
	plt.close()


#---PLOT 2 Compare subgroup
	legend_plot_2 = {0:'CG with correlation, eps=5e-1', 1:'CG with correlation, eps=1e-1', 2:'CG with correlation, eps=1e-2'}
	times_list  = [times_method_1, times_method_2, times_method_3]

	L1_SVM_CG_plots_errorbar(type_Sigma, N, P_list, k0, rho, tau_SNR, times_list, legend_plot_2, 'time')
...
#---PLOT 1 Compare everybody
	objvals_list  = [objvals_SVM_CG_method_0, objvals_SVM_CG_method_1, objvals_SVM_CG_method_2, objvals_SVM_CG_method_3]
	L1_SVM_CG_plots_errorbar(type_Sigma, N, P_list, k0, rho, tau_SNR, objvals_list, legend_plot_1, 'objval')
	plt.savefig(pathname+'/compare_objective_values.pdf')
	plt.close()


#---PLOT 2 Compare subgroup
	objvals_list  = [objvals_SVM_CG_method_0, objvals_SVM_CG_method_2, objvals_SVM_CG_method_3]
	legend_plot_3 = {0:'No CG', 1:'CG with correlation, eps=1e-1', 2:'CG with correlation, eps=1e-2'}
	L1_SVM_CG_plots_errorbar(type_Sigma, N, P_list, k0, rho, tau_SNR, objvals_list, legend_plot_3, 'objval')
