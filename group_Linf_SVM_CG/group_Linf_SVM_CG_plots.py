...
def group_Linf_SVM_CG_plots(type_Sigma, N, P_list, k0, rho, tau_SNR, times_L1_SVM, times_penalizedSVM_R, times_SAM_R_SVM, times_SVM_CG):
...
def group_Linf_SVM_CG_plots_path(type_Sigma, N, P_list, k0, rho, tau_SNR, times_L1_SVM_averaged, times_SVM_CG_averaged_delete, times_SVM_CG_averaged_no_delete):
...
def group_Linf_SVM_plots_errorbar(type_Sigma, arg_list, k0, rho, tau_SNR, times_list, legend_plot, time_or_objval, small_large):
